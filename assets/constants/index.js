...
let chainId, trans_URL;
let blockHash, blocktimeStamp, currentDate;
// token contract

let tokenAdd = "0x6eaf209c9198336ba3c17af7491d68051e351906";
let tokenABI = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IJobkeep3rV1Helper",
        name: "",
        type: "address",
      },
    ],
...
let presaleContract;
let presale_token_Rate, presale_weiRaised, remainingBalance;

//User Values
let userJKP3RBalance;
let bondActivationTime;
let bondsBalance;
let isKeeper;
